  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-[#67BFA1] to-[#3d7563] p-8 text-center">
        ...
        <div className="p-8 flex flex-col gap-6">
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleCopy}
                className="p-3 bg-[#67BFA1] text-white rounded-lg hover:bg-[#52A98A] transition-colors flex items-center justify-center"
                title="Copiar código"
              >
          ...
          <button
            onClick={onClose}
            className="w-full h-12 bg-[#67BFA1] text-white font-bold rounded-xl hover:bg-[#52A98A] transition-colors shadow-lg shadow-[#67BFA1]/25"
          >
            Continuar
          </button>
        </div>
