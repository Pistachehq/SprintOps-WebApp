            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8 flex flex-col min-h-0 shadow-sm">
              ...
              <div className="flex items-center gap-8 mb-6 shrink-0">
                <div className="relative shrink-0">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 w-9 h-9 bg-[#67BFA1] text-white rounded-full flex items-center justify-center hover:bg-[#52A98A] transition-colors shadow-md"
                  >
                    <Camera size={15} />
                  </button>
                </div>
              ...
              {hasChanges && (
                <button
                  ...
                  onClick={handleSave}
                  disabled={saving}
                  className="flex shrink-0 items-center gap-2 bg-[#67BFA1] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#52A98A] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  <Save size={18} />
