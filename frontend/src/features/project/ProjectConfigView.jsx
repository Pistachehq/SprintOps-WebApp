    ...
    <div className="fixed top-[70px] left-0 right-0 bottom-0 bg-[#F0EFED] z-30 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 p-10 overflow-y-auto">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="bg-gradient-to-r from-[#67BFA1] to-[#3a7562] rounded-2xl p-8 shadow-sm border border-[#67BFA1] mb-10">
                          ...
                          {editingSprintId === s.id ? (
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {canCreateSprint && (
                                  <>
                                    <button onClick={() => startEditSprint(s)} className="p-1.5 text-slate-400 hover:text-[#67BFA1] hover:bg-oracle-main/10 rounded-lg transition-colors">
                                      <Pencil size={14} />
                                    </button>
                ...
                {editingMemberIdx === idx ? (
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {canManageMembers && (
                        <>
                          <button onClick={() => startEditMember(idx)} className="p-1.5 text-slate-400 hover:text-[#67BFA1] hover:bg-oracle-main/10 rounded-lg transition-colors">
                            <Pencil size={14} />
                          </button>
                  ...
                  <div className="p-4 bg-slate-50 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1.5 text-slate-400 hover:text-[#67BFA1] hover:bg-oracle-main/10 rounded-lg transition-colors"
                        title="Ver permisos"
                      >
                        <Eye size={14} />
                      </button>
